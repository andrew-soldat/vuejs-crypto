  ...
  methods: {
    addTicker() {
      if (this.ticker.trim().length > 0) {
        ...
        setInterval(async () => {
          const f = await fetch(
            `https://min-api.cryptocompare.com/data/price?fsym=${newTicker.name}&tsyms=USD&key=6d22c77eeb77aa8094333ff4f97d5a2a3edd8026068adc6a9d915761a7f8f498`
          );
